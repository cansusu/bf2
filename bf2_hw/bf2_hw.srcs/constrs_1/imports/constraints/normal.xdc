...
#set_max_fanout 16 [get_cells multi_cores_top_0/inst/core_gen[*].hash_pipeline_inst]
#set_max_fanout 12 [get_cells multi_cores_top_0/inst/core_gen[*].hash_pipeline_inst/md4_inst]
#set_max_fanout 8 [get_cells multi_cores_top_0/inst/core_gen[*].hash_pipeline_inst/pwd_gen_inst]
...
set_property PULLUP true [get_ports {LED_A1[0]}]
...
set_property PULLUP true [get_ports {LED_A2[0]}]
...
set_property PULLUP true [get_ports {LED_A3[0]}]
...
set_property PULLUP true [get_ports {LED_A4[0]}]
